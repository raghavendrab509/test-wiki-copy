...
public class ReviewContent {
    ...
    private Integer profileReviewId;
    ...
    public Integer getProfileReviewId() {
        return this.profileReviewId;
    }

    public void setProfileReviewId(final Integer profileReviewId) {
        this.profileReviewId = profileReviewId;
    }
